  ...
  return (
    <div className="relative bg-black p-2 border-4 border-[#555] font-mono shadow-[0_0_20px_rgba(0,0,0,0.4)]">
      <div className="bg-[#222] p-1 border-2 border-[#444]">
        <div className="relative bg-emerald-900 border-y-2 border-emerald-700 overflow-hidden h-84">
          ...
          {horses.map((horse, index) => {
            ...
            return (
              <div key={horse.id} className="relative h-16 border-b border-emerald-800/50 flex items-center">
